...
var QuizBin = ""
...
// CheckBoard is a paid mutator transaction binding the contract method 0x77f46bff.
//
// Solidity: function checkBoard() returns(bool)
func (_Quiz *QuizTransactor) CheckBoard(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Quiz.contract.Transact(opts, "checkBoard")
}

// CheckBoard is a paid mutator transaction binding the contract method 0x77f46bff.
//
// Solidity: function checkBoard() returns(bool)
func (_Quiz *QuizSession) CheckBoard() (*types.Transaction, error) {
	return _Quiz.Contract.CheckBoard(&_Quiz.TransactOpts)
}

// CheckBoard is a paid mutator transaction binding the contract method 0x77f46bff.
//
// Solidity: function checkBoard() returns(bool)
func (_Quiz *QuizTransactorSession) CheckBoard() (*types.Transaction, error) {
	return _Quiz.Contract.CheckBoard(&_Quiz.TransactOpts)
}

// Question is a paid mutator transaction binding the contract method 0x3fad9ae0.
//
// Solidity: function question() returns(string)
func (_Quiz *QuizTransactor) Question(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Quiz.contract.Transact(opts, "question")
}

// Question is a paid mutator transaction binding the contract method 0x3fad9ae0.
//
// Solidity: function question() returns(string)
func (_Quiz *QuizSession) Question() (*types.Transaction, error) {
	return _Quiz.Contract.Question(&_Quiz.TransactOpts)
}

// Question is a paid mutator transaction binding the contract method 0x3fad9ae0.
//
// Solidity: function question() returns(string)
func (_Quiz *QuizTransactorSession) Question() (*types.Transaction, error) {
	return _Quiz.Contract.Question(&_Quiz.TransactOpts)
}
